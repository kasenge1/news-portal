...
<a href="{{url('news/details/'.$item->id.'/'.$item->news_slug_title)}}"><img class="lazyload" src="{{{(!empty($item->image))? url($item->image):url('upload/no_image.jpg')}}}" ></a>
</div>
...
<img alt="" src="{{(!empty($reporter->photo))?url('upload/user_images/'.$reporter->photo):url('upload/no_image.jpg')}}" class="avatar avatar-96 photo" height="96" width="96" loading="lazy"> </figure>
