            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form  method="POST" action="{{route('store.newspost')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="form-group col-md-12 mb-3">
                                    ...
                                    <img src="{{ url('upload/no_image.jpg')}}" class="rounded avatar-lg img-thumbnail" alt="newspost-image" id="showImage">
                                </div>

                                 <div class="form-group col-md-12 mb-3">
                                    <label for="news_details" class="form-label">News Details</label>
                                    <textarea class="form-control" name="news_details">{{old('news_details')}}</textarea>
                                     @error('news_details')
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-check mb-2 form-check-primary">
                                            <input type="checkbox" class="form-check-input"  name="breaking_news" id="check1" value="1">
                                            <label class="form-check-label" for="check1">Breaking News</label>
                                        </div>

                                        <div class="form-check mb-2 form-check-primary">
                                            <input type="checkbox" class="form-check-input" name="top_slider" id="check2" value="1">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-check mb-2 form-check-primary">
                                            <input type="checkbox" class="form-check-input"  name="first_section_three" id="check3" value="1">
                                            <label class="form-check-label" for="check3">First Section Three</label>
                                        </div>

                                        <div class="form-check mb-2 form-check-primary">
                                            <input type="checkbox" class="form-check-input"  name="first_section_nine" id="check4" value="1">
                            ...
                            <button type="submit" class="btn btn-primary waves-effect waves-light">Add New post</button>
